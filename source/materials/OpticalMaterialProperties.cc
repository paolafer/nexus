...
G4MaterialPropertiesTable* OpticalMaterialProperties::LXe()
{
  ...
  G4double sc_energy[sc_entries];
  for (int j=0;j<sc_entries;j++){
    sc_energy[j] =  6.20625*eV + 0.01*j*eV;
  }
  G4double intensity[sc_entries];
...
const G4int sc_entries = 63;
 ...
 G4double sc_energy[] = {1.9629408004008015, 1.9908574214449701, 2.017487971587794, 2.049118407065618,
2.075153360986118, 2.1108921203127564, 2.131530815691394, 2.1549516183402426, 2.1788791714153226,
2.2008686890176556, 2.225818446565337, 2.2461704051922378, 2.2774394451688957, 2.2933838194379406,
2.309537681443672, 2.3287011454278184, 2.34534235398821, 2.365099103796332, 2.382250183859144,
2.4085359216953424, 2.4233406375845, 2.456622921785144, 2.4782281493172356, 2.503411781001508,
2.52588828700936, 2.5487533714262676, 2.572055225192039, 2.588926183988832, 2.6025967807599906,
2.623400276029348, 2.6374283564632037, 2.6588048713474666, 2.6623164236046244, 2.6877929388662145,
2.713729981831732, 2.7325282355525173, 2.7593839494903407, 2.7907427243849288, 2.83096946231753,
2.885218973585188, 2.9197414497478893, 2.9417873478198326, 2.9732295992116424, 2.991505736849123,
3.005429157443019, 3.0194959021101067, 3.0242886485355824, 3.0432131984421833, 3.048094952090428,
3.057784590715629, 3.0675360309025064, 3.0870759513756334, 3.1271371999622284, 3.1373650393337758,
3.1527828353680922, 3.1734564909877436, 3.189158818959311, 3.199797076377322, 3.2210492254756646,
3.242646039884366, 3.2699528217360423, 3.2976765066977722, 3.3428842485014827};
...
4.718309859154921, 3.450704225352105, 2.3239436619718252, 1.4084507042253518, 0.};
  ...
  mpt->AddProperty("RINDEX", ri_energy, rindex, ri_entries);
  mpt->AddProperty("FASTCOMPONENT", sc_energy, intensity, sc_entries);
  mpt->AddConstProperty("FASTSCINTILLATIONRISETIME", 0.09*ns);
  // mpt->AddProperty("SLOWCOMPONENT", sc_energy, intensity, sc_entries);
  ...
  G4double energy[2] = {0.01*eV, 100.*eV};
  G4double abslen[2] = {41.3*cm, 41.3*cm};
