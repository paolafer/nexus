...
namespace nexus {
  ...
  PetLXeCellCheck::PetLXeCellCheck():
    BaseGeometry(),
  ...
  void PetLXeCellCheck::Construct()
  {
  ...
  void PetLXeCellCheck::BuildDetector() 
  {
 ...
 void PetLXeCellCheck::BuildLXe() 
  ...
  void PetLXeCellCheck::BuildActive() 
  {
    G4Box* active_solid = 
  ...
  void PetLXeCellCheck::BuildSiPMPlane()
  {
 ...
 // void PetLXeCellCheck::BuildSiPMChessPlane()
 //  {
 ...
 //  }
  ...
  G4ThreeVector PetLXeCellCheck::GenerateVertex(const G4String& region) const
  {
