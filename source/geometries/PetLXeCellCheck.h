#ifndef PETLXECELLCHECK__
#define PETLXECELLCHECK__
...
namespace nexus{class PetPlainDiceCheck;}
...
namespace nexus {
  ...
  class PetLXeCellCheck: public BaseGeometry {
  public:
    /// Constructor
    PetLXeCellCheck();
