...
OpBoundaryProcess::OpBoundaryProcess(const G4String& processName,
                                     G4ProcessType ptype)
...
OpBoundaryProcess::~OpBoundaryProcess() = default;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::PreparePhysicsTable(const G4ParticleDefinition&)
{
  Initialise();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::Initialise()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VParticleChange* OpBoundaryProcess::PostStepDoIt(const G4Track& aTrack,
                                                   const G4Step& aStep)
{
  fStatus = Undefined;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::BoundaryProcessVerbose() const
{
  G4cout << " *** ";
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4ThreeVector OpBoundaryProcess::GetFacetNormal(
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::DielectricMetal()
{
  G4int n = 0;
  G4double rand;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::DielectricLUT()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::DielectricLUTDAVIS()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::DielectricDichroic()
{
  // Calculate Angle between Normal and Photon Momentum
  G4double anglePhotonToNormal = fOldMomentum.angle(-fGlobalNormal);
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::DielectricDielectric()
{
  G4bool inside = false;
  G4bool swap   = false;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double OpBoundaryProcess::GetMeanFreePath(const G4Track&, G4double,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double OpBoundaryProcess::GetIncidentAngle()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double OpBoundaryProcess::GetReflectivity(G4double E1_perp,
                                            G4double E1_parl,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::CalculateReflectivity()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4bool OpBoundaryProcess::InvokeSD(const G4Step* pStep)
{
  G4Step aStep = *pStep;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
inline void OpBoundaryProcess::SetInvokeSD(G4bool flag)
{
  fInvokeSD = flag;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::SetVerboseLevel(G4int verbose)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void OpBoundaryProcess::CoatedDielectricDielectric()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double OpBoundaryProcess::GetReflectivityThroughThinLayer(G4double sinTL,
                   G4double E1_perp,
                   G4double E1_parl,
